    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Categoryid,Categoryname,ImageFile")] Category category)
        {
            if (category.ImageFile != null)
            {
                ...
                string fullpath = Path.Combine(wwwrootpath + "/CategoryImages/", imageName);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Categoryid,Categoryname,Categoryimage")] Category category)
        {
